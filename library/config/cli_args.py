...
def add_training_arguments(parser: argparse.ArgumentParser, support_dreambooth: bool):
    ...
    parser.add_argument(
        "--monitor",
        action="store_true",
        help="enable the live web training monitor (Chart.js loss/LR dashboard "
        "served over HTTP). Off by default.",
    )
    parser.add_argument(
        "--monitor_host",
        type=str,
        default="127.0.0.1",
        help="host/interface for the web monitor (default 127.0.0.1; use 0.0.0.0 "
    ...
    parser.add_argument(
        ...
        type=int,
        default=8766,
        help="port for the web monitor (default 8766).",
    )
    parser.add_argument(
        "--monitor_open_browser",
        action="store_true",
        help="open the monitor dashboard in a browser when training starts.",
    )
    parser.add_argument(
        "--huggingface_token",
        type=str,
