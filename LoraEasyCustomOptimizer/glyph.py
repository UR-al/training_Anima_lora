# Glyph from https://github.com/Clybius/Personalized-Optimizers by Clybius
...
class Glyph(Optimizer):
    ...
    def __init__(
        ...
        super(Glyph, self).__init__(params, defaults)
    ...
    def step(self, closure = None):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                c_t = self.smoothen_oscillation(c_t, p_fp32.data)
